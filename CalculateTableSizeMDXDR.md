...
| where Timestamp > ago(30d)              // Use 'TimeGenerated' if you are running this in Sentinel
...
| union (
    ...
    | extend TableName = "--- TOTAL SUM ---"          // Names the grand total row
)
